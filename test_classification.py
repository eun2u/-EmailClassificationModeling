...
if __name__ == "__main__":
    ...
    #     result = []
    #     for i in range(4):
    #         testfoldername = "test_data"+str(i+1)
    ...
    #         result.append(check(full_file_list, full_file_list2))

    #     print(result)
    #     print("평균 : "+ str(sum(result)/float(len(result)))+"%")
    testfoldername = input("테스트할 폴더 : ")
    foldername = input("결과를 비교할 폴더 이름 : ")
    full_file_list2 = checkfile_list_in_folder(foldername, index_info, testfoldername)
    #print(index_info)
    #print(full_file_list2)
    print(check(full_file_list, full_file_list2)+"%")